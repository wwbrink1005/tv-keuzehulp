...
(function () {
  ...
  const CATEGORIES = ["tv", "laptop", "monitor", "desktop", "printer", "wasmachine", "koelkast", "soundbar", "vriezer", "wasdroger", "vaatwasser", "robotstofzuiger", "airfryer", "beamer", "koffiemachine"];
