...
const PRINTER_IMAGES = {
  tekst:    "keuzehulpen/printer-keuzehulp/images/Tekst.png",
  gemengd:  "keuzehulpen/printer-keuzehulp/images/Gemengd.png",
  foto:     "keuzehulpen/printer-keuzehulp/images/Foto.png",
  zakelijk: "keuzehulpen/printer-keuzehulp/images/Zakelijk.png"
};
...
function buildAnswers() {
  return {
    ...
    mobielPrinten: qs('input[name="mobielPrinten"]:checked')?.value ?? ""
  };
}

function handleStartMatching() {
  const checked = qs('input[name="mobielPrinten"]:checked');
  ...
  prefetchProducts()
    .then(rawProducts => {
      ...
      setTimeout(() => {
        window.location.href = "keuzehulpen/printer-keuzehulp/resultaat";
      }, 180);
    })
    .catch(() => {
